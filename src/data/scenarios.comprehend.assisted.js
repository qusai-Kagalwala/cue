...
export const ASSISTED_COMPREHEND = {
  ...
  l8: {
    student: { scenario: 'You asked an AI to explain a maths concept for tomorrow. Read it.', aiResponse: 'The area of a circle is pi times the radius (A = π × r). This gives the space inside. Practise a few examples and you are ready.', task: 'Decide your next step — use it, redo it, or verify first — and say why.' },
    everyday: { scenario: 'You asked for cough remedies. Read the reply.', aiResponse: 'Drink warm water with honey and ginger, avoid cold drinks, rest your voice. You can also take 2 teaspoons of cough syrup every 4 hours.', task: 'Decide your next step — use it, redo it, or verify first — and say why.' },
    professional: { scenario: 'You asked an AI to draft a contract clause. Read it.', aiResponse: 'The Client agrees to indemnify and hold harmless the Service Provider against any and all liabilities, without limitation, arising from the engagement.', task: 'Decide your next step — use it, redo it, or verify first — and say why.' },
  },
}