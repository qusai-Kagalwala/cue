...
export const PROGRAMME = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Correct & keep ✅', 'Fix the biggest problem, and keep the useful part.'],
      ['Read the medium 🛡️', 'Turn the same skill on AI-made photos, videos, and code — verify the source instead of guessing real-or-fake.'],
    ],
